...
{
    static const char profile[] BLYNK_PROGMEM = "blnkinf\0" BLYNK_PARAM_KV("ver", BLYNK_VERSION)
...
#endif
                                    BLYNK_PARAM_KV("build", __DATE__ " " __TIME__) "\0";
...
template <class Proto>
BLYNK_FORCE_INLINE void BlynkApi<Proto>::processCmd(const void *buff, size_t len)
{
